          ...
          <div className="col-lg-6">
            <div className="pabout-right">
              ...
              <div className="tech-wrap">
                ...
                <div className="tech-box" >
                  <div className="icon-main">
                    <span className="flaticon-electron" />
                  </div>
                </div>
                <div className="tech-box" >
                  <div className="icon-main">
                    <span className="flaticon-java" />
                  </div>
                </div>
                <div className="tech-box" >
                  <div className="icon-main">
              ...
              <div className="ot-button">
                <a href="it-services.html" className="btn-details">
                  <i className="flaticon-right-arrow-1" /> LEARN MORE
                </a>
              </div>
            </div>
          </div>
              ...
              <div className="team-thumb">
                ...
                <div className="team-social flex-middle">
                  <div>
                    ...
                    <a rel="nofollow" href="linkedin.html" className="linkedin">
                      <i className="fab fa-linkedin-in" />
                    </a>
                    <a rel="nofollow" href="pinterest.html" className="pinterest">
                      <i className="fab fa-pinterest-p" />
                    </a>
                    <a rel="nofollow" href="instagram.html" className="instagram">
